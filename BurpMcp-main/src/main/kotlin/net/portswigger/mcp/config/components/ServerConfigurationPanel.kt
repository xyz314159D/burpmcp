...
class ServerConfigurationPanel(
    ...
    private fun buildPanel() {
        ...
        val onlyReturnInScopeHistoryCheckBox = createStandardCheckBox(
            "Only return in-scope proxy HTTP history", config.onlyReturnInScopeHistory
        ) { config.onlyReturnInScopeHistory = it }
        add(onlyReturnInScopeHistoryCheckBox)
        add(createVerticalStrut(Design.Spacing.MD))
